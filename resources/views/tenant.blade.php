...
<div class="container margin_30 mb-5">
    ...
    <p class="images-users">
        <img src="{{ asset('/img/tenant/1.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
    </p>
    ...
    <p class="images-users">
        <img src="{{ asset('/img/tenant/2-1.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
        <img src="{{ asset('/img/tenant/2-2.png') }}" class="rounded-2 border border-1 border-dark mt-3" alt="" width="1256">
        <img src="{{ asset('/img/tenant/2-3.png') }}" class="rounded-2 border border-1 border-dark mt-3" alt="" width="1256">
    </p>
    <p class="text-rob-20 mt-2">
    ...
    <p class="images-users">
        <img src="{{ asset('/img/tenant/2-4.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="558">
    </p>
    <p class="text-rob-20 mt-2">
    ...
    <p class="images-users">
        <img src="{{ asset('/img/tenant/2-5.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
    </p>
    ...
    <p class="images-users">
        <img src="{{ asset('/img/tenant/3.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
    </p>
    ...
    <p class="images-users">
        <img src="{{ asset('/img/tenant/4-1.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
    </p>
    <p class="text-rob-20 mt-2">
    ...
    <p class="images-users">
        <img src="{{ asset('/img/tenant/4-2.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
    </p>
    ...
    <p class="images-users">
        <img src="{{ asset('/img/tenant/5-1.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
    </p>
    <p class="text-rob-20 mt-2">
    ...
    <p class="images-users">
        <img src="{{ asset('/img/tenant/5-2.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
    </p>
    ...
    <p class="images-users">
        <img src="{{ asset('/img/tenant/6-1.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
    </p>
    <p class="text-rob-20 mt-2">
        При клике на кнопку открывается окно с подробной информацией об аренде.
    </p>
    <p class="images-users">
        <img src="{{ asset('/img/tenant/6-2.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="523">
    </p>
</div>
