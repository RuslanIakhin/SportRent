...
<div class="container margin_30 mb-5">
    ...
    <h2 class="text-rob-30 mt-3">1. Войти или зарегистрироватся</h2>
    ...
    <p class="images-users">
        <img src="{{ asset('/img/lessor/1.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
    </p>
    ...
    <p class="images-users">
        <img src="{{ asset('/img/lessor/2.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
    </p>
    ...
    <p class="images-users">
        <img src="{{ asset('/img/lessor/3-1.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
    </p>
    <p class="text-rob-20 mt-2"> 
    ...
    <p class="images-users">
        <img src="{{ asset('/img/lessor/3-2.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
    </p>
    ...
    <div class="par-3">
        ...
        <p class="images-users">
            <img src="{{ asset('/img/lessor/3-1-1.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="855">
        </p>
        <p class="text-rob-20 mt-2">
        ...
        <p class="images-users">
            <img src="{{ asset('/img/lessor/3-1-2.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="561">
        </p>
        <p class="text-rob-20 mt-2">
            После добавления карты её номер будет отображаться в вашем личном кабинете.
        </p>
        <p class="images-users">
            <img src="{{ asset('/img/lessor/3-1-3.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
        </p>
        ...
        <p class="images-users">
            <img src="{{ asset('/img/lessor/3-2-1.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="855">
        </p>
        <p class="text-rob-20 mt-2">
        ...
        <p class="images-users">
            <img src="{{ asset('/img/lessor/3-2-2.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="551">
        </p>
        <p class="text-rob-20 mt-2">
            После смены номер новой карты будет отображаться в вашем личном кабинете вместо старой.
        </p>
        <p class="images-users">
            <img src="{{ asset('/img/lessor/3-2-3.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
        </p>
    </div>
    ...
    <p class="images-users">
        <img src="{{ asset('/img/lessor/4-1.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
    </p>
    <p class="text-rob-20 mt-2">
    ...
    <p class="images-users">
        <img src="{{ asset('/img/lessor/4-2.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="555">
    </p>
    <p class="text-rob-20 mt-2">
    ...
    <p class="images-users">
        <img src="{{ asset('/img/lessor/5.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
    </p>
    ...
    <p class="images-users">
        <img src="{{ asset('/img/lessor/6-1.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
    </p>
    <p class="text-rob-20 mt-2">
        Для принятия или отказа от заявки нажмите на кнопку “Принять решение” и выберите нужное Вам действие.
    </p>
    <p class="images-users">
        <img src="{{ asset('/img/lessor/6-2.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
    </p>
    ...
    <p class="images-users">
        <img src="{{ asset('/img/lessor/7.png') }}" class="rounded-2 border border-1 border-dark" alt="" width="1256">
    </p>
</div>
